...
%w[ /var/lib/jenkins/jobs/primefactors/workspace/prime_factors_kata/db/seeds.rb /var/lib/jenkins/jobs/primefactors/workspace/prime_factors_kata/db/schema.rb ].each do |path|
  directory path do
    owner 'root'
    group 'root'
    mode '0777'
